<!--
   - $File: JCS_DestroyParticleEffect.html $
   - $Date: 2018-10-01 20:35:53 $
   - $Revision: $
...
<table>
  ...
  <tr>
    <td>mRandPos</td>
    <td>Randomize the position when spawn the particle system.</td>
  </tr>
  <tr>
    <td>mRandPosRange</td>
  ...
  <tr>
    <td>mRandRot</td>
    <td>Randomize the rotation when spawn the particle system.</td>
  </tr>
  <tr>
    <td>mRandRotRange</td>
  ...
  <tr>
    <td>mRandScale</td>
    <td>Randomize the scale when spawn the particle system.</td>
  </tr>
  <tr>
